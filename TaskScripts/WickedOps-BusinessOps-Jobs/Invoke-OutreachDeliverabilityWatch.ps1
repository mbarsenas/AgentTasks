...
if($total){Write-WickedOpsLog $LogPath "$total deliverability/suppression signal(s) require review." WARN}else{Write-WickedOpsLog $LogPath 'No deliverability or suppression signals require review.'}
